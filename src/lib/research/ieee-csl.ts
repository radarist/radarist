// IEEE CSL style, vendored from citation-style-language/styles (CC-BY-SA-3.0).
// See THIRD-PARTY-NOTICES.md.
//
// This is the full, unmodified contents of the upstream `ieee.csl` file,
// inlined as a string constant so `citation.ts` never needs a runtime
// `readFileSync` against a `.csl` asset (which may not survive Next.js /
// turbopack production bundling — see citation.ts's module doc comment).
export const IEEE_CSL_XML = `<?xml version="1.0" encoding="utf-8"?>
